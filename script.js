...
const filterElements = [brightnessRange, contrastRange, grayscaleRange, blurRange, sepiaRange, hueRange, saturateRange, invertRange];
...
function applyFilters() {
    if (currentImage) {
        ...
        const filterValue = `brightness(${brightnessValue}%) contrast(${contrastValue}%) grayscale(${grayscaleValue}%) blur(${blurValue}px) sepia(${sepiaValue}%) hue-rotate(${hueValue}deg) saturate(${saturateValue}%) invert(${invertValue}%)`;
